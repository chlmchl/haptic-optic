    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            for (let i = 1; i < data_array.length; i++) {
                ...
                //let rowAdditionnalCreditsNode = document.createTextNode(rowInfo[7])
                credits.push(items)
            }
            
        }
    };
    xhttp.open("GET", "https://sheets.googleapis.com/v4/spreadsheets/1r6SlOhO0UVo9ZrvpXhYDMQwhZhF0xOYQwWhZnvhd6L4/values/index?key=AIzaSyDhlpOIwLeSZUTfp1OUPRagso6CMgbMzOA");
    xhttp.send();
    // console.log(credits);
